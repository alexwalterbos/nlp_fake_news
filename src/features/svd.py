...
headlineTfidf = headlineTfidfTrain
articleTfidf = articleTfidfTrain
...
if testNum > 0:
	...
	headlineTfidf = vstack((headlineTfidfTrain, headlineTfidfTest))
	articleTfidf = vstack((articleTfidfTrain, articleTfidfTest))
